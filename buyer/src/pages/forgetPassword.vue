  ...
  <div class="login">
    ...
    <div class="foot">
      <Row type="flex" justify="space-around" class="help">
        <a class="item" href="https://mszlu.com/" target="_blank">帮助</a>
        <a class="item" href="https://mszlu.com/" target="_blank">隐私</a>
        <a class="item" href="https://mszlu.com/" target="_blank">条款</a>
      </Row>
      <Row type="flex" justify="center" class="copyright">
        Copyright © 2021 - Present
        <a href="https://mszlu.com/" target="_blank" style="margin: 0 5px"
          >码神之路</a>
        >
        版权所有
      </Row>
